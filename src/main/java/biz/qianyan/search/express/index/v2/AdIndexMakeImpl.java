...
import biz.qianyan.search.db.model.BusiOrderDAO;
...
public class AdIndexMakeImpl implements IndexMaker {
    ...
    public AdIndexMakeImpl(String indexdir, Analyzer analyzer, BusiOrderDAO dao, DocumentParser docparser) {
        super();
                ...
                try {
                    ...
                    if (ad.getType() == 1 && ad.getConfigtype() == 0) {
                        ...
                        if (ad.getInfotype() == 1) {
                            ...
                            if (l.size() > 0)
                                ed = DocumentParser.tranfer(l.get(0));
