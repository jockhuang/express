package com.qianyan.search.zhuanli.index.v1;
...
import com.qianyan.search.db.model.VwSearchPatentDAO;
...
public class IndexMakeImpl implements IndexMake {
    ...
    public IndexMakeImpl(String indexdir, Analyzer analyzer, VwSearchPatentDAO dao,
